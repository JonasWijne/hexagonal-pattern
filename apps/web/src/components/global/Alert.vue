                ...
                >
                    ...
                    >
                        ...
                        <div class="bg-gray-50 px-4 py-3 sm:px-6 flex flex-col text-center sm:flex-row-reverse">
                            <button
                                class="inline-flex items-center px-4 py-2 text-sm font-medium rounded-md text-white border border-transparent"
                                :class="{
                                    'bg-red-600': type == 'warning',
...
<script lang="ts" setup>
    ...
    const { showAlert, type, confirmAction, cancelAction } = withDefaults(defineProps<IProps>(), {
        showAlert: false,
        type: 'warning',
        confirmAction: () => {
